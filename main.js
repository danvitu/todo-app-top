...
function createNewTodo (title, desc, dueDate, priority, list) {
  ...
  return {title,
          desc,
          dueDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.format)(new Date(dueDate), 'dd LLLL yyyy'),
          priority,
          list,
          complete}
}
...
// Test Todo
const newTodo = (0,_createTodo__WEBPACK_IMPORTED_MODULE_3__.createNewTodo)('Create a website', 'Using Tilda', '2024 8 2', 'mid', 'Default');
